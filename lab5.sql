...
insert all
  ...
  into subjects (subject_name) values ('История России')
...
-- students
insert all
  into students (first_name, last_name, specialty_id, receipt_year) values ('Алексей', 'Тютерев', 1, 2018)
  into students (first_name, last_name, specialty_id, receipt_year) values ('Сергей', 'Козлов', 2, 2020)
  into students (first_name, last_name, specialty_id, receipt_year) values ('Никита', 'Иванов', 1, 2019)
  into students (first_name, last_name, specialty_id, receipt_year) values ('Ирина', 'Белова', 2, 2018)
select * from dual;
...
--marks
insert all
  into marks (mark, student_id, receiving_date, syllabus_id, subject_id) values (2, 4, date'2021-03-20', 9, 4)
  into marks (mark, student_id, receiving_date, syllabus_id, subject_id) values (3, 4, date'2021-02-11', 9, 3)
  ...
  into marks (mark, student_id, receiving_date, syllabus_id, subject_id) values (null, 2, date'2021-03-21', 9, 4)
  into marks (mark, student_id, receiving_date, syllabus_id, subject_id) values (null, 1, date'2021-03-21', 1, 1)
  into marks (mark, student_id, receiving_date, syllabus_id, subject_id) values (5, 1, date'2021-02-15', 1, 2)
  into marks (mark, student_id, receiving_date, syllabus_id, subject_id) values (3, 3, date'2021-04-17', 1, 2)
select * from dual;
...
/*
Написать запрос, выводящий список должников на текущий момент времени (сколько
семестров проучился студент вычислять из года поступления и текущей
