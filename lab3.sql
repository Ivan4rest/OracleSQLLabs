/*
є1
¬ыбрать с помощью иерархического запроса сотрудников 3-его уровн€ иерархии (т.е.
...
/*
є2
ƒл€ каждого сотрудника выбрать всех его начальников по иерархии. ¬ывести пол€: код
...
/*
є3
ƒл€ каждого сотрудника посчитать количество его подчиненных, как непосредственных,
...
/*
є4
ƒл€ каждого заказчика выбрать в виде строки через зап€тую даты его заказов. ƒл€
...
/*
є5
¬ыполнить задание є 4 c помощью обычного запроса с группировкой и функцией
listagg.
ќтвет: 47 строк.
*/
select  o.customer_id,
...
/*
є6
¬ыполнить задание є 2 с помощью рекурсивного запроса.
ƒл€ каждого сотрудника выбрать всех его начальников по иерархии. ¬ывести пол€: код
сотрудника, им€ сотрудника (фамили€ + им€ через пробел), код начальника, им€
начальника (фамили€ + им€ через пробел), кол-во промежуточных начальников между
сотрудником и начальником из данной строки выборки. ≈сли у какого-то сотрудника
...
/*
є7
¬ыполнить задание є 3 с помощью рекурсивного запроса.
ƒл€ каждого сотрудника посчитать количество его подчиненных, как непосредственных,
так и по иерархии. ¬ывести пол€: код сотрудника, им€ сотрудника (фамили€ + им€ через
пробел), общее кол-во подчиненных.
ќтвет: 50 строк.
...
/*
є8
 аждому менеджеру по продажам сопоставить последний его заказ. ћенеджером по
...
/*
є9
ƒл€ каждого мес€ца текущего года найти первые и последние рабочие и выходные дни с
...
¬ыходные дни на 2021 год вз€л с сайта: https://calendar.yoip.ru/work/2021-proizvodstvennyj-calendar.html
ќтвет: 12 строк.
*/
with 
days as
...
/*
є11
«авести нового клиента С—тарый клиентТ с менеджером, который €вл€етс€
...
/*
є12
ƒл€ клиента, созданного в предыдущем запросе, (найти можно по максимальному id
...
/*
є13
ƒл€ каждого клиента удалить самый первый заказ. ƒолжно быть 2 запроса: первый Ц дл€
...
/*
є14
ƒл€ товаров, по которым не было ни одного заказа, уменьшить цену в 2 раза (округлив
...
/*
є15
»мпортировать в базу данных из прайс-листа фирмы Ђ–етї (http://www.voronezh.ret.ru/?
